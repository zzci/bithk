...
export const Route = createLazyFileRoute("/_app/portal/projects/")({
...
function ProjectsListPage() {
  ...
  const handleCreate = (values: CreateProjectInput) => {
    createProject.mutate(values, {
      onSuccess: (project) => {
        setCreateOpen(false);
        void navigate({ to: "/portal/projects/$projectId", params: { projectId: project.id } });
      },
    });
  };
              ...
              : projects.length === 0
                ...
                : projects.map(project => (
                    <TableRow
                      ...
                      onClick={() => void navigate({ to: "/portal/projects/$projectId", params: { projectId: project.id } })}
                    >
