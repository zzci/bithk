...
// that page stays mounted underneath; the panel renders inside a resizable
// right-side drawer (ported from the access issue list) portaled to <body> so
// the overlay always covers the full viewport. "Maximize" navigates to the
