...
export const fixtureProjectTags: readonly ProjectTag[] = [
  { id: "tag-refit", type: "project", name: "Refit", usageCount: 1 },
  { id: "tag-main-engine", type: "project", name: "Main engine", usageCount: 1 },
  { id: "tag-nav", type: "project", name: "Navigation", usageCount: 1 },
  { id: "tag-newbuild", type: "project", name: "Newbuild", usageCount: 1 },
  { id: "tag-trial", type: "project", name: "Sea trial", usageCount: 2 },
  { id: "tag-urgent", type: "project", name: "Urgent", usageCount: 1 },
] as const;

export const fixtureProjects: readonly ProjectView[] = [
  {
    id: "proj-atlas-refit",
    sections: ["issues", "procurement"],
    coverImageUrl: null,
    code: "ATL-REFIT-2026",
  ...
  },
  {
    ...
    tags: [{ id: "tag-pm", name: "PM", usageCount: 1 }],
